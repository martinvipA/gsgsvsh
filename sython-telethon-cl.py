...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        buttons = [
             [Button.inline('تـعـيـن user الـبـوت 🎭', 'ububo')],
             [Button.inline('حـذف رقـم 🕹️', 'delete'), Button.inline('اضـافـة رقـم ❇️', 'button1')],
            [Button.inline('بــــدء التجميع ✈️', 'button3'), Button.inline('ايقاف التجميع 🛑 ', 'button4')],
            [Button.inline('تـحويل النقاط 📮', 'button5'), Button.inline('عــدد الـنـقـاط 💾', 'button6')],
            [Button.inline('فك الحضر 🟢', 'unblock'), Button.inline('حضر البوت 🔴', 'button21')],
            [Button.inline('مغادرة القنوات 🚀', 'buttton11'), Button.inline('الهـديـه اليـومـيـه 🎁 ', 'a6gi2ft')],
        [Button.inline('رشق تـصـويت 🤍', 'button7'), Button.inline('تـفــعـيل بــوت  🤖', 'button8')],
        [Button.inline('مـغـادرة قـنـاة 👤', 'buttton251'), Button.inline('انـضـمـام قـنـاة  👤', 'buttton311')],
          [Button.inline('تحكم خـاص 📮', 'btp'), Button.inline('فحص الحسابات 🛠️', 'tst')],
        [Button.inline('عدد الحسابات 🧤', "bbuttoon08")],  
        [Button.inline('رشق مشاهدات 👁️‍🗨️', 'buttonn511')],
        [Button.inline('لـنـصـيب بـوت مـمـاثـل 🤖', 'trrqgvwvb2')],
        ]
        await bot.send_message(chat, '''**Source Martin collect bot points**''', buttons=buttons)
...
async def back(event):
        ...
        await event.edit("""**Source Martin collect bot points**""", buttons=buttons)
...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        buttons = [
            ...
            [Button.inline('اخـتـيـار الـحـسـاب 🕹️', 'kacc')],
            
            [Button.inline('بــــدء التجميع ✈️', 'aabo'), Button.inline('ايقاف التجميع 🛑 ', 'abbo')],
            [Button.inline('تـحويل النقاط 📮', 'acbo'), Button.inline('عــدد الـنـقـاط 💾', 'adbo')],
        ...
        [Button.inline('رشق مشاهدات 👁️‍🗨️', 'akbo')],
        [Button.inline('لـنـصـيب بـوت مـمـاثـل 🤖', 'trrqgvwvb2')],
...
@bot.on(events.CallbackQuery(pattern='trrqgvwvb2'))
async def callback(event):
    await event.edit("لـنـصـيـب بـوت مـمـاثـل راسـل الـمـطـور :@F_V_3", buttons=[Button.inline("• رجــوع • ", "back")])
